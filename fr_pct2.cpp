...
static char usage[] = "usage: fr_pct2 (-debug) (-premium) (-not_premium) filename\n";
...
int main(int argc,char **argv)
{
  ...
  for ( ; ; ) {
    ...
    printf("%6.2lf%% (folded on the river on %d of %d hands) %s\n",dwork,fr_count,hands,filename);
  }
  ...
  if (!total_hands)
    ...
    dwork = (double)total_fr_count / (double)total_hands * (double)100;

  printf("\n%6.2lf%% (folded on the river on %d of %d total_hands)\n",dwork,total_fr_count,total_hands);
