...
#define NUM_OMAHA_FOUR_FLOP_CARDS 19
#define NUM_REMAINING_CARDS (NUM_CARDS_IN_DECK - NUM_OMAHA_FOUR_FLOP_CARDS)

#define MAX_LINE_LEN 1024
static char line[MAX_LINE_LEN];

static char usage[] = "usage: omaha_four_flop (-debug) (-verbose) filename";
...
int main(int argc,char **argv)
{
  ...
  int line_no;
  int line_len;
  int cards[NUM_OMAHA_FOUR_FLOP_CARDS];
  ...
  for ( ; ; ) {
    ...
    for (n = 0; n < NUM_OMAHA_FOUR_FLOP_CARDS; n++) {
      ...
      if (n < NUM_OMAHA_FOUR_FLOP_CARDS - 1) {
        // skip whitespace
    ...
    for (n = 0; n < NUM_CARDS_IN_DECK; n++) {
      for (o = 0; o < NUM_OMAHA_FOUR_FLOP_CARDS; o++) {
        if (n == cards[o])
          break;
      }

      if (o == NUM_OMAHA_FOUR_FLOP_CARDS)
        remaining_cards[m++] = n;
    }
    ...
    for (o = 0; o < POKER_33_2_PERMUTATIONS; o++) {
      ...
      if (bVerbose) {
        ...
        cout << card_string << " ";
        card_string_from_card_value(remaining_cards[n],card_string);
        cout << card_string << " ";
      }

      omaha_hand[0].NewCards(cards[0],cards[1],cards[2],cards[3],
        cards[16],cards[17],cards[18],
