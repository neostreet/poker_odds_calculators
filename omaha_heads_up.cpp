...
#define NUM_PREFLOP_CARDS (NUM_PLAYERS * NUM_HOLE_CARDS_IN_OMAHA_HAND)
#define NUM_REMAINING_CARDS (NUM_CARDS_IN_DECK - NUM_PREFLOP_CARDS)

#define MAX_LINE_LEN 1024
static char line[MAX_LINE_LEN];

static char usage[] = "usage: omaha_heads_up (-debug) filename";
...
int main(int argc,char **argv)
{
  ...
  for ( ; ; ) {
    ...
    for (r = 0; r < POKER_44_5_PERMUTATIONS; r++) {
      ...
      hand[0] = omaha_hand[0].BestPokerHand(false);
      hand[1] = omaha_hand[1].BestPokerHand(false);
