...
static char usage[] = "usage: permute_holdem_hands_short_deck (-verbose)\n";
...
int main(int argc,char **argv)
{
  ...
  for (t = 0; t < POKER_36_7_PERMUTATIONS; t++) {
  ...
  for (n = 0; n < NUM_HAND_TYPES; n++) {
    pct = (double)hand_counts[hand_type_ixs[n]] / (double)POKER_36_7_PERMUTATIONS;
    printf("%s %9d %9.6lf\n",hand_type_abbrevs[hand_type_ixs[n]],hand_counts[hand_type_ixs[n]],pct);
  }

  printf("============\n");
  printf("   %9d\n",POKER_36_7_PERMUTATIONS);
